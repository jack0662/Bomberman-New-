...
public class BlastRight extends Blast {

    public static final int DEFAULT_WIDTH = 32, DEFAULT_HEIGHT = 32;

    public BlastRight(Holder holder, int x, int y,Individual owner) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.blastRight, (int) (posX - this.holder.getGame().getCamera().getxOffset()),
