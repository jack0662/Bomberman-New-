...
public class BlastLeft extends Blast {

    public static final int DEFAULT_WIDTH = 32, DEFAULT_HEIGHT = 32;

    public BlastLeft(Holder holder, int x, int y,Individual owner) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.blastLeft, (int) (posX - this.holder.getGame().getCamera().getxOffset()),
